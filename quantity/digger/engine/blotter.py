...
from quantity.digger.errors import TradingError
from quantity.digger.engine.api import SimulateTraderAPI
from quantity.digger.event import Event
...
class SimpleBlotter(Blotter):
    """
    简单的订单管理系统，直接给 :class:`quantity.digger.engine.exchange.Exchange`
    对象发订单，没有风控。
    """
